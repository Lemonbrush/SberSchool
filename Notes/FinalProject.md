...
#### Эксперт 1
Читаемость кода и чистота 2
Стабильность приложения	3
Архитектура 2
Работа UI: коллекции, верстка, анимации 4
Работа с хранилищами, сетью, потоками 3
Тесты и вот это всё 3
Общая субъективная оценка 3
Сумма 20
Среднее 2.86

#### Эксперт 2
Читаемость кода и чистота	3
Стабильность приложения	3
Архитектура	2
Работа UI: коллекции, верстка, анимации	3
Работа с хранилищами, сетью, потоками	3
Тесты и вот это всё	3
