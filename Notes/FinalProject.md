...
# [🎖 Ссылка на проект 🎖](https://github.com/Lemonbrush/Weather/tree/SberSchoolProject) / [📈 Презентация 📉](https://github.com/Lemonbrush/SberSchool/blob/master/Presentations/FinalProject.pdf)
...
### Оценки
|             Критерии оценки               | Эксперт 1 | Эксперт 2 | Эксперт 3 |
|             :---                          |    :---   |   :---    |   :---    | 
|**Читаемость кода и чистота**              | 2         | 2         | 3         |
|**Стабильность приложения**	            | 3         | 3         | 3         |
|**Архитектура**                            | 2         | 2         | 3         |
|**Работа UI: коллекции, верстка, анимации**| 4         | 3         | 4         |
|**Работа с хранилищами, сетью, потоками**  | 3         | 3         | 3         |
|**Тесты и вот это всё**                    | 3         | 3         | 4         |
|**Общая субъективная оценка**              | 3         | 4         | 4         |
|**Сумма**                                  | 20        | 21        | 24        |
|**Среднее**                                | 2.86      | 3         | 3.4       |
