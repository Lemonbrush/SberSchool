...
class ViewController: UIViewController {
    ...
    let builder: NotificationBuilderProtocol = NotificationBuilder()
...
private extension ViewController {
        ...
        @objc func buttonTapped() {
            ...
            UNUserNotificationCenter.current().add(request) { error in print(error?.localizedDescription ?? "error") }
        }
}
